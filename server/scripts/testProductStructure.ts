...
async function testProductStructure() {
  try {
    ...
    console.log(
      ...
      typeof firstProduct.basePrice,
    );
    console.log(
      "OriginalPrice:",
      firstProduct.originalPrice,
      typeof firstProduct.originalPrice,
    );
    ...
    if (firstProduct.variants && firstProduct.variants.length > 0) {
      console.log(
        ...
        typeof firstProduct.variants[0].price,
      );
      console.log(
        "First variant originalPrice:",
        firstProduct.variants[0].originalPrice,
        typeof firstProduct.variants[0].originalPrice,
      );
    }
