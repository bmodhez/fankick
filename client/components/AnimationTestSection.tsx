...
import {
  useBottleDropSequence,
  useImmediateDropAnimation,
} from "@/components/VisibleDropAnimation";
import { Star, Heart, ShoppingBag, Zap, Crown, Gift } from "lucide-react";
...
export function AnimationTestSection() {
  ...
  const testImage =
    "https://cdn.builder.io/api/v1/image/assets%2Fc7d7a55a70cb48c2b58c8c2fd35f2ab0%2Fccb843686000436c9595becec62b0d73?format=webp&width=800";
  ...
  const imageRef = useImmediateDropAnimation(
    -500,
    2.5,
    0.8,
    "elastic.out(1, 0.3)",
  ...
  useLayoutEffect(() => {
    ...
    return () => {
      const floatingBottles = container.querySelectorAll(
        '[class*="floating-bottle-"]',
      );
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 bg-gradient-to-br from-gray-900 via-blue-900/20 to-gray-900 relative overflow-hidden min-h-screen"
    >
      {/* Background */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {testCards.map((card, index) => (
            ...
            >
              <div
                className={`w-16 h-16 ${card.color} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
              >
