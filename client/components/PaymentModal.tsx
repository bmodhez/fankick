          ...
          <CardContent className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-4 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold">{orderDetails.trackingNumber}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="font-bold">
                {formatPrice(product.price * product.quantity, selectedCurrency.code)}
              </span>
            </div>
            ...
            <div className="space-y-2 text-sm border-t pt-3">
              ...
              <div className="flex justify-between">
                <span>Shipping:</span>
                <span>{shippingCost === 0 ? 'FREE' : formatPrice(shippingCost, selectedCurrency.code)}</span>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {codAvailable && (
                <div 
                  className={`border rounded-lg p-4 cursor-pointer transition-all ${
                    selectedPayment === 'cod' ? 'border-primary bg-primary/5' : 'border-gray-300'
                  }`}
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <Badge className="ml-auto bg-green-100 text-green-800">Popular</Badge>
                  </div>
                </div>
              )}
              ...
              {selectedCurrency.code === 'INR' && (
                <div 
                  className={`border rounded-lg p-4 cursor-pointer transition-all ${
                    selectedPayment === 'razorpay' ? 'border-primary bg-primary/5' : 'border-gray-300'
                  }`}
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <Badge className="ml-auto bg-blue-100 text-blue-800">Instant</Badge>
                  </div>
                </div>
              )}
              ...
              {selectedCurrency.code !== 'INR' && (
                <>
                  <div 
                    className={`border rounded-lg p-4 cursor-pointer transition-all ${
                      selectedPayment === 'stripe' ? 'border-primary bg-primary/5' : 'border-gray-300'
                    }`}
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <Badge className="ml-auto bg-purple-100 text-purple-800">Secure</Badge>
                    </div>
                  </div>

                  <div 
                    className={`border rounded-lg p-4 cursor-pointer transition-all ${
                      selectedPayment === 'paypal' ? 'border-primary bg-primary/5' : 'border-gray-300'
                    }`}
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <Badge className="ml-auto bg-yellow-100 text-yellow-800">Global</Badge>
                    </div>
                  </div>
                </>
              )}
