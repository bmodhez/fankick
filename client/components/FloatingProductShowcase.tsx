...
export function FloatingProductShowcase() {
  ...
  const productImage = "https://cdn.builder.io/api/v1/image/assets%2Fc7d7a55a70cb48c2b58c8c2fd35f2ab0%2Fec7a7628276e428785772b407d17037d?format=webp&width=800";
  
  const showcaseRef = useRef<HTMLDivElement>(null);
  const titleRef = useScrollDrop(-200, 0, "top 80%", "top 40%", "bounce.out");
  const productRef = useScrollDrop(-300, 0, "top 75%", "top 35%", "elastic.out(1, 0.75)");
  const detailsRef = useScrollDrop(-150, 0, "top 70%", "top 30%", "back.out(1.7)");
  ...
  useLayoutEffect(() => {
    ...
    return () => {
      ...
      // Clean up images
      const floatingImages = container.querySelectorAll('[class*="floating-product-"]');
      floatingImages.forEach(img => img.remove());
    };
  }, [productImage]);

  return (
    <section ref={showcaseRef} className="py-20 bg-gradient-to-br from-gray-900 via-purple-900/10 to-gray-900 relative overflow-hidden min-h-screen">
      {/* Background Elements */}
          ...
          <div className="space-y-8">
            ...
            <div ref={titleRef}>
              ...
              <p className="text-xl text-gray-300 max-w-lg">
                Experience our premium products with scroll-controlled animations. 
                Each item gracefully falls into position as you explore our collection.
              </p>
            </div>
            ...
            <div ref={detailsRef} className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-white font-medium">4.9/5 (2,341 reviews)</span>
              </div>

              <div className="flex items-center space-x-6">
                <div>
                  <span className="text-3xl font-bold text-primary">₹2,499</span>
                  <span className="text-lg text-gray-400 line-through ml-2">₹3,999</span>
                </div>
