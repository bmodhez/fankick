...
import {
  useMobileHeroAnimation,
  useMobilePerformanceOptimization,
} from "@/hooks/useResponsiveGSAP";
import {
  useHeroDropAnimation,
  useFloatingImageDrop,
} from "@/hooks/useScrollDrop";
import {
  useHeroDramaticDrop,
  showAnimationDebug,
  ...
  const heroSlides = [
    {
      ...
      subtitle:
        "Discover premium football jerseys, anime collectibles, and pop culture merchandise",
      cta: "Shop Now",
      accent: "🏆 #1 Fan Store",
      image:
    ...
    },
    {
      ...
      subtitle:
        "Limited edition anime merchandise and rare football collectibles",
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div
              ref={ctaRef}
              className="hero-cta flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12 mobile-hero-cta tablet-hero-elements desktop-hero-elements"
            >
              <Link to="/collections">
                <Button
            ...
            <div
              ref={statsRef}
              className="hero-stats grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 mobile-hero-elements tablet-hero-elements desktop-hero-elements"
            >
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="text-center group mobile-optimized tablet-optimized desktop-enhanced"
                >
