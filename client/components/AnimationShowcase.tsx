...
import { useGSAP, useScrollFadeIn, useStaggerAnimation, useCounterAnimation, useMagneticEffect } from '@/hooks/useGSAP';
...
export function AnimationShowcase() {
  ...
  return (
    <section ref={showcaseRef} className="py-20 bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Welcome to FanKick's revolutionary animated experience. Every scroll, hover, and interaction 
            has been crafted with precision using GSAP and ScrollTrigger for the ultimate user experience.
          </p>
